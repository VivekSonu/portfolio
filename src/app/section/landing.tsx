      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 mt-8 ">
        ...
        <div className="h-[40rem] flex flex-col items-center justify-center overflow-hidden rounded-md ">
          ...
          >
            ...
            <div className="absolute inset-0 w-full h-full border border-transparent rounded-b-full rounded-t-xl bg-black  [mask-image:radial-gradient(200px_90px_at_top,transparent_20%,white)] sm:[mask-image:radial-gradient(350px_200px_at_top,transparent_20%,white)]">
              {/* <TextRevealCards/> */}
            </div>
          </motion.div>
          <motion.div
